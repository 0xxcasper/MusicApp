...
//        view.setBorder(cornerRadius: 8)
    ...
    private var type: PopUpType = .fromLeftToCenter
    ...
    func showPopUpNotRemoveView(width: CGFloat = 350 , height: CGFloat = 250, type: PopUpType = PopUpType.zoomOut) {
...
//            }
    ...
    func showPopUp(width: CGFloat = 350 , height: CGFloat = 250, type: PopUpType = PopUpType.zoomOut) {
    ...
    private func showPopUpBeforeAnimation(type: PopUpType) {
        self.vBackGround.alpha = 0
        switch type {
        case .fromBottomToCenter:
    ...
    private func showPopWithAnimation(type: PopUpType) {
