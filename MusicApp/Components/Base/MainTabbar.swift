...
class MainTabbar: UITabBarController {
    ...
    func setUpViewController() {
        ...
        homeNC.tabBarItem = UITabBarItem(title: "", image: #imageLiteral(resourceName: "ic_music"), tag: 0)
        ...
        searchNC.tabBarItem = UITabBarItem(title: "", image: #imageLiteral(resourceName: "ic_search"), tag: 1)
        ...
        moreNC.tabBarItem = UITabBarItem(title: "", image: #imageLiteral(resourceName: "ic_more"), tag: 2)
